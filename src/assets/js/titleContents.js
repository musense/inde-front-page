...
export async function getTitleContents() {
  const response = await instance.get(`/editor?limit=10&pageNumber=1`)
    .then(res => res.data)
...
export async function getTitleContentsByCategory(payload) {
  ...
  // const response = await instance.get(`/editor?limit=10&categoryName=${category}&pageNumber=${page}`)
  const response = await instance.get(`/categories/${categoryName}?limit=10&pageNumber=${page}`)
    .then(res => res.data)
  // const { data, currentPage, limit, totalCount, totalPages } = response
...
export async function geRelatedArticles(payload) {
  const { _id } = payload
  // const response = await instance.get(`/editor?limit=10&categoryName=${category}&pageNumber=${page}`)
